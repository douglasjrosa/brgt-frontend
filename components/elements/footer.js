...
const Footer = () =>
{
	return (
		<footer className="bg-brgt-forest bg-fixed bg-cover bg-top relative">
			<div
				id="main-footer"
				className="grid bg-black bg-opacity-60 grid-cols md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 p-12"
			>
							...
							{ footerColumn.links &&
								footerColumn.links.map( ( link, linkIndex ) => (
									<li
										...
										className="py-3 lg:py-2 text-xl mx-1 my-4 text-yellow-300 hover:text-yellow-100 overflow-hidden max-w-full min-w-0"
									>
