	...
	features: [
		{
			...
			title: 'Em construção',
			description:
				'Em breve traremos aqui informações técnicas sobre diversos modelos de paletes, estrados e embalagens. Além disso você saberá mais sobre como funciona o tratamento para exportação e suas implicações. Aguarde...',
			link: null,
			media: {
